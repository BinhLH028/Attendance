...
public class WebConfig implements WebMvcConfigurer {
    ...
    public FilterRegistrationBean corsFilter() {
        ...
        config.addAllowedOrigin("http://localhost:3082");
        ...
        config.setAllowedHeaders(Arrays.asList(
                ...
                HttpHeaders.ACCEPT, "Custom-Header", "Content-type","multipart/form-data"));
        ...
        return new WebMvcConfigurer() {
            ...
            public void addCorsMappings(CorsRegistry registry) {
                registry.addMapping("/**")
                        ...
                        .allowedOrigins("http://localhost:3000","http://localhost:3082","http://192.168.1.66:3000","https://attendancefe.onrender.com/","http://103.143.207.183:3082");
            }
        };
    }
